...
public abstract class Champion implements Damageable,Comparable {
	...
	public String toString() {
		...
		ArrayList<String> abilities1 = new ArrayList<String>();
		
		for(Ability a : abilities) {	
			abilities1.add(a.getName());	
		}
		
		return "\n " + name + " \n HP: " + maxHP + "\n Mana: " + mana + "\n Max Action Pts: " + maxActionPointsPerTurn + "\n Speed: " + speed +
				"\n Attack Range: " + attackRange + "\n Attack Damage: " + attackDamage + "\n Abilities: " + abilities1.toString();
	}
	
	public String toStringCurr() {
		
		return "\n " + name + "\n Mana: " + mana + "\n Current Action Pts: " + currentActionPoints + "/" + maxActionPointsPerTurn + "\n Attack Range: " + attackRange 
				+ "\n Attack Damage: " + attackDamage +"\n Applied Effects: " + appliedEffects.toString();
